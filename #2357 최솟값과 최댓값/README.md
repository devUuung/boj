# <img width="20px"  src="https://d2gd6pc034wcta.cloudfront.net/tier/15.svg" class="solvedac-tier"> [최솟값과 최댓값](https://www.acmicpc.net/problem/2357) 

| 제출 번호 | 닉네임 | 채점 결과 | 메모리 | 시간 | 언어 | 코드 길이 |
|---|---|---|---|---|---|---|
|62731409|dev_ung|맞았습니다!! |9940KB|96ms|C++17|1703B|
